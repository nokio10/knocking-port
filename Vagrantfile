...
:vm_name => "inetRouter",
:net => [
{ip: '192.168.255.13', adapter: 2, netmask: "255.255.255.252",
virtualbox__intnet: "router-net"},
{ip: '192.168.50.9', adapter: 8},
]
},
:centralRouter => {
:box_name => "centos7",
...
Vagrant.configure("2") do |config|
    MACHINES.each do |boxname, boxconfig|
        ...
        if boxname.to_s == "inetRouter2"
          box.vm.network "forwarded_port", guest: 8080, guest_ip: "192.168.255.13", host: 8080, host_ip: "127.0.0.1",  protocol: "tcp"
        end
